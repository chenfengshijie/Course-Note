...
![1664795864704](image/Network_layer/1664795864704.png)
<center>HOL</center>
...
32 位的IP地址会导致IP地址不够分配。新开发的IPv6协议使用128位定义IP地址，并在协议中简化了报文格式，提升报文的处理速度。
